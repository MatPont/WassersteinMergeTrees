...
#ifndef _MERGETREEPROGRESSIVE_H
#define _MERGETREEPROGRESSIVE_H
...
namespace ttk {
  ...
  class MergeTreeDistanceProgressive : virtual public Debug, public MergeTreeBase {
