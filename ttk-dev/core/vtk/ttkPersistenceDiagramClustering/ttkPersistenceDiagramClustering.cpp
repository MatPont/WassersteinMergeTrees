...
vtkSmartPointer<vtkUnstructuredGrid>
  ...
  /////////////////////////////////////////////////////////////////////////////
  vtkNew<vtkIntArray> baryMatchingID{};
  baryMatchingID->SetName("BaryMatchingID");
  std::vector<std::vector<int>> baryMatchingIDCor(NumberOfClusters);
  for(int i = 0; i < NumberOfClusters; ++i)
    baryMatchingIDCor[i] = std::vector<int>(final_centroids_[i].size(), -1);
  int cptBaryMatchingID = 0;
  /////////////////////////////////////////////////////////////////////////////
    ...
    for(unsigned int i = 0; i < matchings_j.size(); ++i) {
      ...
      if(bidder_id < (int)diagram.size()) {
        ...
        if(good_id > -1) {
          ...
          /////////////////////////////////////////////////////////////////////////////
          if(baryMatchingIDCor[c][good_id] == -1){
            baryMatchingIDCor[c][good_id] = cptBaryMatchingID;
            cptBaryMatchingID++;
          }
          baryMatchingID->InsertTuple1(count, baryMatchingIDCor[c][good_id]);
          /////////////////////////////////////////////////////////////////////////////
  ...
  /////////////////////////////////////////////////////////////////////////////
  matchingMesh->GetCellData()->AddArray(baryMatchingID);
  /////////////////////////////////////////////////////////////////////////////
