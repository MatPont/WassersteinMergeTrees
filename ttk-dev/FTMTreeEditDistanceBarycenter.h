...
#pragma omp taskwait
        ...
        int persistenceScaling(std::vector<ftm::FTMTree_MT *> &trees, std::vector<MergeTree *> &mergeTrees,
          ...
          for(int i = 0; i < oriTrees.size(); ++i){
            ...
            if(iterationNumber != -1){
              ...
              int decrement = iterationNumber/4 * pairs.size()/10;
              int thresholdIndex = pairs.size() - noPairs - std::max(decrement, 1);
        ...
        // Postprocessing
        // ----------------------------------------
        // TODO see fixMergedRootOrigin in FTMTreeEditDistanceBase
        template <class dataType>
